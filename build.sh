...
LIBS="user32 ${VULKAN_SDK}/Lib/vulkan-1.lib -lcomdlg32 -lgdi32 -lwinmm -lsetupapi -loleaut32 -lole32 -limm32.lib -lversion -ladvapi32 -lshell32 -lWs2_32 -lSecur32 -lBcrypt -lole32 -ldxguid -lMfplat -lMfuuid -lstrmiids -ldsound"
